...
const buildKey = (scene: Scene, parent: TransformNode, props: KeyProps) => {
  if (props.type === "white") {
    /*
...
const scaleFromPivot = function(transformNode: TransformNode, pivotPoint: Vector3, scale: number) {
